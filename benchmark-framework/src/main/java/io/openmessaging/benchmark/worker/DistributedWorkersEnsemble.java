...
public class DistributedWorkersEnsemble implements Worker {
    ...
    private final AsyncHttpClient httpClient = buildHttpClient();

    private int numberOfUsedProducerWorkers;

    private static AsyncHttpClient buildHttpClient(){
        DefaultAsyncHttpClientConfig.Builder confBuilder = new DefaultAsyncHttpClientConfig.Builder();
        confBuilder.setRequestTimeout(120*1000);
//        confBuilder.setConnectTimeout(30*1000);
        confBuilder.setReadTimeout(120*1000);
